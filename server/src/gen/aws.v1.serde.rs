...
impl serde::Serialize for TestMethodRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer.serialize_struct("aws.v1.TestMethodRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for TestMethodRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aws.v1.TestMethodRequest")
            }
        ...
        deserializer.deserialize_struct("aws.v1.TestMethodRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TestMethodResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("aws.v1.TestMethodResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for TestMethodResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aws.v1.TestMethodResponse")
            }
        ...
        deserializer.deserialize_struct("aws.v1.TestMethodResponse", FIELDS, GeneratedVisitor)
    }
}
